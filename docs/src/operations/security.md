...
| `libduckdb-sys` | `=1.10504.0` | DuckDB C API bindings (re-exported by quack-rs; kept explicitly for `sessionize` window function FFI) |
...
gh attestation verify behavioral-v0.9.0-linux_amd64.tar.gz \
