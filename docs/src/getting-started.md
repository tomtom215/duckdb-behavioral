...
- DuckDB CLI v1.5.4 (for running queries)
...
(`v1.5.4`). You must use a DuckDB CLI version that matches. Check your version
with:
...
If you see a different version, either install DuckDB v1.5.4 or rebuild the
